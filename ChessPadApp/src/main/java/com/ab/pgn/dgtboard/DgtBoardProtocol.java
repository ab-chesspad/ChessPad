...
/**
 * Source: https://github.com/nurv/lirec/blob/master/scenarios/MyFriend/GameCompanion/iCatChess/iCatChess/ElectronicBoard/dgtbrd13.h
...
---------------------*/
    ...
    byte
        ...
        DGT_END_DEBUG_MODE = (byte)0x90,	// end debug mode, undocumented message
...
/* DEFINITION OF THE BOARD-TO-PC MESSAGE ID CODES and message descriptions */
        ...
        DGT_MSG_BOARD_DUMP = (byte) 0x86,
        DGT_MSG_SBI_TIME = (byte) 0x8d,
        DGT_MSG_FIELD_UPDATE = (byte) 0x8e,
        DGT_MSG_LOG_MOVES = (byte) 0x8f,
        DGT_MSG_BUSADDRESS = (byte) 0x90,
        DGT_MSG_SERIALNR = (byte) 0x91,
        DGT_MSG_TRADEMARK = (byte) 0x92,
        DGT_MSG_VERSION = (byte) 0x93,
