...
public class MoveValidationTest extends BaseTest {
    ...
    public void testPawn() throws IOException {
        ...
        final Pair<String, Integer>[] moves = new Pair[] {
                new Pair<>("e5xd6", Config.INIT_POSITION_FLAGS | Config.FLAGS_BLACK_MOVE),
                ...
                new Pair<>("b7b8", Config.INIT_POSITION_FLAGS | Config.FLAGS_BLACK_MOVE),
                new Pair<>("b7xc8", Config.INIT_POSITION_FLAGS | Config.FLAGS_BLACK_MOVE),
    ...
    @Test
    @SuppressWarnings("unchecked")
    public void tesKnight() throws IOException {
        String fen = "7k/N7/8/4N3/8/8/8/1K6 w - - 0 1";
        final Pair<String, Integer>[] moves = new Pair[] {
                new Pair<>("Nac6", Config.FLAGS_AMBIG | Config.FLAGS_BLACK_MOVE),
//                {"e5xf6", YES},
    ...
    public void testKing() throws IOException {
        ...
        final Pair<String, Integer>[] moves = new Pair[] {
                new Pair<>("o-o-o", Config.FLAGS_B_QUEEN_OK | Config.FLAGS_B_KING_OK | Config.FLAGS_BLACK_MOVE),
                new Pair<>("0-0-0", Config.FLAGS_B_QUEEN_OK | Config.FLAGS_B_KING_OK | Config.FLAGS_BLACK_MOVE),
    ...
    public void testMate() throws IOException {
        ...
        final Pair<String, Integer>[] moves = new Pair[] {
                new Pair<>("Qd8h4#", Config.INIT_POSITION_FLAGS),
        };
        testMoves(fen, moves);
    }
    ...
    public void testMateDoubleCheck() throws IOException {
        ...
        final Pair<String, Integer>[] moves = new Pair[] {
                new Pair<>("Nf7d6#", Config.INIT_POSITION_FLAGS | Config.FLAGS_BLACK_MOVE),
        };
        testMoves(fen, moves);
    }
    ...
    public void testMateEnpass() throws IOException {
        ...
        final Pair<String, Integer>[] moves = new Pair[] {
                new Pair<>("g2g4#", Config.FLAGS_ENPASSANT_OK | Config.FLAGS_BLACK_MOVE),
        };
        testMoves(fen, moves);
    }
    ...
    public void testMateCastle() throws IOException {
        ...
        final Pair<String, Integer>[] moves = new Pair[] {
                new Pair<>("0-0-0#", Config.FLAGS_BLACK_MOVE),
        };
        testMoves(fen, moves);
    }
    ...
    public void testQCastle() throws IOException {
        ...
        final Pair<String, Integer>[] fens = new Pair[]{
                new Pair<>("r3k2r/8/8/5b2/8/8/8/R3K2R w KQkq - 0 1", Config.FLAGS_B_KING_OK | Config.FLAGS_B_QUEEN_OK | Config.FLAGS_BLACK_MOVE),
