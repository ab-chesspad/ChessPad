...
//        String fen = "r3k2r/8/8/1b3b2/8/8/5n3/R3K2R w KQkq - 0 1";
        ...
        final Pair<String, Integer>[] moves = new Pair[] {
                ...
                new Pair<>("Kxf2", Config.FLAGS_B_QUEEN_OK | Config.FLAGS_B_KING_OK),
                new Pair<>("Kd2", Config.FLAGS_B_QUEEN_OK | Config.FLAGS_B_KING_OK),
                new Pair<>("Ke1e2", ERR),
                new Pair<>("o-o", ERR),
                new Pair<>("0-0", ERR),
                new Pair<>("Ke1g3", ERR),
    ...
    public void testRook() throws Config.PGNException {
        ...
        final Pair<String, Integer>[] moves = new Pair[] {
                ...
                new Pair<>("Rb7+", Config.FLAGS_CHECK | Config.FLAGS_BLACK_MOVE),
                new Pair<>("Re2e1+", ERR),
        };
        testMoves(fen, moves);
    }
    ...
    public void testRook1() throws Config.PGNException {
        ...
        final Pair<String, Integer>[] moves = new Pair[] {
                new Pair<>("Rb8", Config.FLAGS_B_KING_OK | Config.FLAGS_BLACK_MOVE),
        };
        testMoves(fen, moves);
    }
    ...
    public void testMate() throws Config.PGNException {
        ...
        final Pair<String, Integer>[] moves = new Pair[] {
                new Pair<>("Qh4#", Config.INIT_POSITION_FLAGS | Config.FLAGS_CHECKMATE | Config.FLAGS_BLACK_MOVE),
        };
        testMoves(fen, moves);
    }
    ...
    public void testMateDoubleCheck() throws Config.PGNException {
        ...
        final Pair<String, Integer>[] moves = new Pair[] {
                new Pair<>("Nd6#", Config.INIT_POSITION_FLAGS | Config.FLAGS_CHECKMATE),
        };
        testMoves(fen, moves);
    }
    ...
    public void testCheck() throws Config.PGNException {
        ...
        final Pair<String, Integer>[] moves = new Pair[] {
                new Pair<>("Nd6+", Config.INIT_POSITION_FLAGS | Config.FLAGS_CHECK),
        };
        testMoves(fen, moves);
    }
    ...
    public void testCheck1() throws Config.PGNException {
        ...
        final Pair<String, Integer>[] moves = new Pair[] {
                new Pair<>("g4+", Config.FLAGS_ENPASSANT_OK | Config.FLAGS_CHECK),
        };
        testMoves(fen, moves);
    }
